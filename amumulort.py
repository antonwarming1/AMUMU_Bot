...
class TCPServerNode(Node):
    ...
    def tcpServerListen(self):
        ...
        while True:
            ...
            messageReceive = messageReceive[:len(messageReceive)-1]
            self.get_logger().info("The client said: %s" % str(messageReceive))

            # Check if message is empty
            if not str(messageReceive) == "b''":
                ...
                self.get_logger().info("The client said nothing, waiting for new message")
